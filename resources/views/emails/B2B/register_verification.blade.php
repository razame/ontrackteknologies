...
<head>
  ...
  <title>Tripser B2B - Account Verification</title>
  <style type="text/css">
    a {
        ...
        <tr>
          <td class="o_bg-dark o_px o_py-md o_br-t o_sans o_text" align="center"
            ...
            <p style="margin-top: 0px;margin-bottom: 0px;"><a class="o_text-white" href="https://example.com/"
                  ...
                  src="http://tripserb2b.com/agent/img/logo.png" width="136" height="36" alt="tripserb2b.com"
      ...
      <table class="o_block" width="100%" cellspacing="0" cellpadding="0" border="0" role="presentation"
        ...
        <tr>
          <td class="o_bg-ultra_light o_px-md o_py-xl o_xs-py-md o_sans o_text-md o_text-light" align="center"
            ...
            <table role="presentation" cellspacing="0" cellpadding="0" border="0">
              ...
              <tr>
                ...
                <td rowspan="2" class="o_sans o_text o_text-secondary o_px o_py" align="center"
                  ...
                  <img src="images/email-48-primary.png" width="48" height="48" alt=""
            ...
            <p style="margin-top: 0px;margin-bottom: 0px;">Please confirm that you want to use this as your TRIPSERB2B
              ...
              <tr>
                <td width="300" class="o_btn o_bg-primary o_br o_heading o_text" align="center"
                  ...
                  <a class="o_text-white"
                     href="http://tripserb2b.com/agents/verify/email/{{$user->id}}/{{$data['token']}}"
      ...
      <table class="o_block" width="100%" cellspacing="0" cellpadding="0" border="0" role="presentation"
        ...
        <tr>
          <td class="o_bg-white o_px-md o_py o_sans o_text o_text-secondary" align="center"
            ...
            <p style="margin-top: 0px;margin-bottom: 0px;">Please, click on 'Verify My E-mail Address' to continue your
              registration.</p>
          </td>
        </tr>
        </tbody>
      ...
      <table class="o_block" width="100%" cellspacing="0" cellpadding="0" border="0" role="presentation"
        ...
        <tr>
          <td class="o_bg-white o_px-md o_py-lg o_bt-light o_br-b o_sans o_text-xs o_text-light" align="center"
            ...
            <p class="o_mb" style="margin-top: 0px;margin-bottom: 16px;"><a class="o_text-primary"
                                                                            href="https://tripserb2b.com/"
                                                                            style="text-decoration: none;outline: none;color: #126de5;"><img
                  src="http://tripserb2b.com/agent/img/logo.png" width="36" height="36" alt="Tripserb2b.com"
            ...
            <p class="o_mb" style="margin-top: 0px;margin-bottom: 16px;">©{{date('Y')}} TripserB2B</p>
