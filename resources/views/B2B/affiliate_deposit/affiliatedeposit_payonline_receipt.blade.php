            ...
            <div class="checkout-wrap w-100">
              ...
              <div class="order-table-wrap w-100 mt-5">
                @if( $resp['result'] == "SUCCESS")
                  ...
                  <table class="order-table w-100">
                    ...
                    <tr class="cart_item">
                      ...
                      <td class="product-total"><span
                          class="price d-inline-block">${{$affiliate_deposit->amount}}</span></td>
                    </tr>
                    <tr class="cart_item">
                    ...
                    <tr>
                      <th>Total</th>
                      <td><strong><span class="price d-inline-block">${{$affiliate_deposit->amount}}</span></strong>
                      </td>
                    </tr>
                    </tfoot>
                  </table>
                  ...
                  <a href="/Affiliate-Deposit-create-pdf-for-bank-receipt/{{$affiliate_deposit->id}}"
