    ...
    <div class="col-lg-12 transaction-report">
      <div class="card">
        <h5 class="card-header">
          Affiliate Deposit - CASH DEPOSITE
        </h5>
        <div class="card-body">
          @if($errors->any())
            ...
            <div class="col-xl-7 col-lg-7">
              <form action="/Affiliate-Deposit-Store" method="post" class="" enctype="multipart/form-data">
                ...
                @else
                  ...
                  <div class="form-group">
                    <label for=""class="text-bold-600">Date Of Transaction</label>
                    <input type='text' class="form-control  format-picker" required name="date_of_transaction"  value="{{ old('date_of_transaction') }}"/>
                  </div>

                  <div class="form-group">
                    <label for="" class="text-bold-600">Bank Name</label>
                    <input type="text" class="form-control" placeholder="Ex: abc bank" name="bank_name"
                           value="{{ old('bank_name') }}">
                  </div>

                  <div class="form-group">
                    <label for="" class="text-bold-600">Bank Receipt</label>
                    <input type="file" class="form-control" placeholder="" name="bank_receipt">
                  </div>


                  <div class="d-flex">

                    <button type="submit" class="btn btn-outline-blue" name="action" value="cach_deposit">Cash Deposit
                    </button>
