...
@section('content')
  ...
  <!--- START FORM ---->
  {{ Form::model($user, array('route' => array('B2B-Users.update', $user->id), 'method' => 'PUT','enctype'=>'multipart/form-data')) }}
                  ...
                  <div class="col-lg-4 col-md-6">
                    <div class="form-group">
                      ...
                      <select name="user_role" id="user_role"
                        ...
                        <option @if($user->user_role == 'AreaManager') selected="selected" @endif  value="AreaManager">
                          Area Manager
                        </option>
                        <option @if($user->user_role == 'Supervisor') selected="selected" @endif  value="Supervisor">
                          Supervisor
                        </option>
                        <option @if($user->user_role == 'ExecutiveUser') selected="selected"
                                @endif  value="ExecutiveUser">Executive User
                        </option>
                      </select>
                    </div>
                  </div>
