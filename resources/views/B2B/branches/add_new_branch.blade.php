...
@section('content')
  ...
  <!--- START FORM ---->
  <form action="{{url('B2B-Branches')}}" method="POST" enctype="multipart/form-data"
                ...
                <div class="row">
                  <div class="col-lg-4 col-md-6">
                    <div class="form-group">
                      ...
                      @else
                        {!! Form::select('parent_id', [$user->id => $user->name], null, ['class' => 'form-control']) !!}
                        @endrole
    ...
    <div class="card">
      <div class="card-body text-right">
        <button class="btn btn--blue mr-1" type="submit">Add Branch</button>
        <span>Or</span>
