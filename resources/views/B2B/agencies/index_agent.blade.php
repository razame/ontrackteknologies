        ...
        @foreach ($users as $user)
          ...
          <tr>
            ...
            <td class="product-category">
              ...
              {{Form::open(['method'  => 'DELETE', 'route' => ['B2B-Agencies.destroy', $user->id]])}}

              <a href="{{ url('B2B-Agencies/'.$user["id"].'/edit') }}"
              ...
              {{Form::button('<i class="feather icon-trash"></i>', array('type' => 'submit', 'class' =>

                'btn btn-icon btn-icon rounded-circle btn-flat-danger mr-1 mb-1 waves-effect waves-light',
      ...
      var dataListView = $(".data-list-view").DataTable({
        ...
        buttons: [

          {
            ...
            text: "<i class='feather icon-plus'></i> Add New Agent",

            action: function () {


              window.location.replace("/B2B-Agencies/create");
