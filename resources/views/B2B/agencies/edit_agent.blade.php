...
@section('content')
  <!--- START FORM ---->
  {{ Form::model($user, array('route' => array('B2B-Agencies.update', $user->id), 'method' => 'PUT','enctype'=>'multipart/form-data')) }}
  @csrf
              ...
              <div class="row">
                ...
                <div class="col-lg-4 col-md-6">
                  <div class="form-group">
                    ...
                    <input type="text" id="primaryEmail" name="email" placeholder="Primary Email ID" required
              ...
              <div class="d-flex align-content-center">
                ...
                <div class="mr-2">
                  <select class="form-control custom-control" name="agency_hotel_markup_type" id="">
                    <option @if($user->agency_hotel_markup_type == 'Flat') selected @endif  value="Flat">Flat</option>
                    <option @if($user->agency_hotel_markup_type == 'Percentage') selected @endif  value="Percentage">
                      Percentage
                    </option>
                  </select>
                </div>
                <div class="mr-2">
                  <input type="text" class="form-control" value="{{$user->agency_hotel_markup_value}}"
                         id="agency_hotel_markup_value" name="agency_hotel_markup_value" placeholder="Ex: 1">
                </div>
              </div>
        ...
        <div class="tab-pane text-dark" id="settings-just" role="tabpanel" aria-labelledby="settings-tab-justified">
          <div class="card">
            <div class="card-body">
              ...
              <p>
                upload your signed contract here.You can upload only one file and it must be no larger than 5 MB and in
                PDF format only.If required, please merge all your documents into one file.
              </p>
  ...
  <div class="card">
    <div class="card-body text-right">
      <button class="btn btn--blue mr-1" type="submit">Update Agent: [{{$user->name}}]</button>
      <span>Or</span>
