...
@section('content')
  ...
  <!--- START FORM ---->
  <form action="{{url('/B2B-Agencies')}}" method="POST" enctype="multipart/form-data"
        ...
        <ul class="nav nav-tabs nav-justified" id="myTab2" role="tablist">
          <li class="nav-item">
            <a class="nav-link active" id="home-tab-justified" data-toggle="tab" href="#home-just" role="tab"
               aria-controls="home-just" aria-selected="true">Agency Profile</a>
          </li>
          <li class="nav-item">
          ...
          <li class="nav-item">
            <a class="nav-link" id="messages-tab-justified" data-toggle="tab" href="#messages-just" role="tab"
               aria-controls="messages-just" aria-selected="false">Agency Markup</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" id="settings-tab-justified" data-toggle="tab" href="#settings-just" role="tab"
               aria-controls="settings-just" aria-selected="false">Documents</a>
          </li>
        </ul>
        ...
        <div class="tab-content pt-1">
          <div class="tab-pane active" id="home-just" role="tabpanel" aria-labelledby="home-tab-justified">
                ...
                <div class="row">
                  ...
                  <div class="col-lg-8 col-md-6">
                    <div class="form-group">
                      <label for="agencyName"><strong>Agency Name: </strong>
                        Agency name will appear in all communication sent to your customers,
                      </label>
                  ...
                  <div class="col-lg-4 col-md-6">
                    <div class="form-group">
                      ...
                      <input type="text" id="no2" name="phone_number_2" value="{{ old('phone_number_2') }}"
                  ...
                  <div class="col-lg-4 col-md-6">
                    <div class="form-group">
                      ...
                      <input type="text" id="pan" name="pan" value="{{ old('pan') }}" placeholder="XXXX1234XX"
                  ...
                  <div class="col-lg-4 col-md-6">
                    <div class="form-group">
                      ...
                      <input type="text" id="tax" name="tax" value="{{ old('tax') }}" placeholder="XXXXHDSAXXY"
                  ...
                  <div class="col-lg-4 col-md-6">
                    <div class="form-group">
                      ...
                      <input type="text" id="pincode" name="pincode" placeholder="Pin Code / Zip Code"
                             value="{{ old('pincode') }}" class="form-control @error('pincode') is-invalid @enderror">
                      @error('pincode')
                      <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                  ...
                  <div class="col-lg-4 col-md-6">
                    <div class="form-group">
                      ...
                      <select name="currency" id="currency" value="{{ old('currency') }}"
                              class="select2 form-control @error('currency') is-invalid @enderror">
                        <option value="USD" @if(old('currency') == 'USD') selected="selected" @endif label="US dollar">
                          USD
                        </option>
                        <option value="EUR" @if(old('currency') == 'EUR') selected="selected" @endif label="Euro">EUR
                        </option>
                      </select>
                    </div>
                  </div>
                  ...
                  <div class="col-lg-8 col-md-6">
                    <div class="form-group">
                      ...
                      <textarea name="email_signature" id="emailsign" rows="8"
                                class="form-control">{{old('email_signature')}}</textarea>
                    </div>
                  </div>
                  <div class="col-lg-4">
                    <label for=""><strong>your Agency Logo:</strong></label>
                    <div class="media agencylogo">
                      <div class="media-heading">
                        {{-- <img src="../../../app-assets/images/img/airport-logo.png" class="img-fluid" alt=""> --}}
                      </div>
            ...
            <div class="col-lg-12 agency-form">
              ...
              <div class="card">
                <h4 class="card-header header-has-bg">Agency Admin</h4>
                ...
                <div class="col-lg-12">
                  <div class="row">
                    <div class="col-xl-5 col-lg-6">
                      <div class="form-group">
                        <h5>Display Agency Logo On:</h5>
                        <div class="d-flex justify-content-between agency-row">
                          <div class="vs-checkbox-con vs-checkbox-primary">
                            <input type="checkbox" checked name='e_ticket' value="1">
                          ...
                          <div class="vs-checkbox-con vs-checkbox-primary">
                            <input type="checkbox" checked name='voucher' value="1">
                            <div class="vs-checkbox">
                              <div class="vs-checkbox--check">
                                <i class="vs-icon feather icon-check"></i>
                              </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="d-flex justify-content-between agency-row">
                          <div class="vs-radio-con">
                            <input type="radio" name="hotel_price_display" value="per_night">
                            <div class="vs-radio">
                          ...
                          <div class="vs-radio-con">
                            <input type="radio" name="hotel_price_display" checked value="whole_stay">
                            <div class="vs-radio">
                              <div class="vs-radio--border"></div>
                              <div class="vs-radio--circle"></div>
                            </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="d-flex justify-content-between agency-row">
                          <div class="vs-checkbox-con vs-checkbox-primary">
                            <input type="checkbox" checked name='enable_user_arkup' value="1">
                            <div class="vs-checkbox">
                              <div class="vs-checkbox--check">
                                <i class="vs-icon feather icon-check"></i>
                              </div>
                          ...
                          <div class="vs-checkbox-con vs-checkbox-primary">
                            <input type="checkbox" checked name='show_user_markup' value="1">
                            <div class="vs-checkbox">
                              <div class="vs-checkbox--check">
                                <i class="vs-icon feather icon-check"></i>
                              </div>
                    ...
                    <div class="col-xl-5 col-lg-6">
                      <div class="form-group">
                        <h5>Agency Markup on Air/Non-Air Search Result:</h5>
                        <div class="d-flex justify-content-between agency-row">
                          <div class="vs-radio-con">
                          ...
                          <div class="vs-radio-con">
                            <input type="radio" name="agency_markup_on_air_non_air_search_result" checked
                                   value="show_marked_up_rate">
                            <div class="vs-radio">
                              <div class="vs-radio--border"></div>
                              <div class="vs-radio--circle"></div>
                            </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="d-flex justify-content-between agency-row">
                          <div class="vs-checkbox-con vs-checkbox-primary">
                            <input type="checkbox" checked name='quick_search_result' value="1">
                            <div class="vs-checkbox">
                              <div class="vs-checkbox--check">
                                <i class="vs-icon feather icon-check"></i>
                              </div>
          ...
          <div class="tab-pane text-dark" id="messages-just" role="tabpanel" aria-labelledby="messages-tab-justified">
            <div class="card">
              <div class="card-body">
                <h5>Non- Air:</h5>
                <div class="mb-2 mt-2"><strong>Hotel</strong></div>

                <div class="d-flex align-content-center">
                  <div class="has-padding-7">All Hotels</div>
                  <div class="mr-2">
                    <select class="form-control custom-control" name="agency_hotel_markup_type" id="">
                      <option value="Flat">Flat</option>
                      <option value="Percentage">Percentage</option>
                    </select>
                  </div>
                  <div class="mr-2">
                    <input type="text" class="form-control" id="agency_hotel_markup_value"
                           name="agency_hotel_markup_value" placeholder="Ex: 1">
                  </div>
                </div>
          ...
          <div class="tab-pane text-dark" id="settings-just" role="tabpanel" aria-labelledby="settings-tab-justified">
            <div class="card">
              <div class="card-body">
                <h5>Your Signed Contract:</h5>
                <p>
                  upload your signed contract here.You can upload only one file and it must be no larger than 5 MB and
                  in PDF format only.If required, please merge all your documents into one file.
                </p>
                <fieldset class="form-group mt-2">
                  <div class="custom-file">
                    <input type="file" name="signed_contract" class="custom-file-input" id="signed_contract">
    ...
    <div class="card">
      <div class="card-body text-right">
        <button class="btn btn--blue mr-1" type="submit">Add Agent</button>
        <span>Or</span>
        <a href="{{url('/B2B-Agencies')}}" class="btn btn-outline-blue ml-1">Cancel</a>
      </div>
    </div>
  </form>
  <!--- END FORM --->
