...
<div
  ...
  <div class="navbar-header">
    <ul class="nav navbar-nav flex-row">
      <li class="nav-item mr-auto"><a class="navbar-brand" href="dashboard-analytics">
          ...
          <h2 class="brand-text mb-0"><img src="/images/logo/tripser-dark.png" class="img-fluid" alt=""></h2>
        </a></li>
  ...
  <div class="main-menu-content">
    <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
      ...
      @role("SuperAdmin")
      @php
        $menuData[0] = $customizedMenuData['SuperAdmin'];
      @endphp
      @endrole

      @role("Agent")
      @php
        $menuData[0] = $customizedMenuData['Agent'];
      @endphp
      @endrole
