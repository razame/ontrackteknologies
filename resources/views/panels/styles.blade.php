...
<link rel="stylesheet" href="{{ asset('css/style.css') }}?version=2020">
<link rel="stylesheet" href="{{ asset('css/custom.css') }}?version=2020">
<link rel="stylesheet" href="{{ asset('css/t-datepicker.min.css') }}">
<link rel="stylesheet" href="{{ asset('css/t-datepicker-blue.css') }}">
