...
(function($) {
    'use strict';
    var Defaults = { autoClose: true, durationArrowTop: 200, titleToday: 'Today', titleDateRange: 'night', titleDateRanges: 'nights', titleDays: ['Mo', 'Tu', 'We', 'Th', 'Fr', 'Sa', 'Su'], titleMonths: ['January', 'February', 'March', 'April', 'May', 'June', 'July', 'August', 'Septemper', 'October', 'November', "December"], titleMonthsLimitShow: 3, replaceTitleMonths: null, showDateTheme: null, iconArrowTop: true, iconDate: '', arrowPrev: '&#x276E;', arrowNext: '&#x276F;', toDayShowTitle: true, dateRangesShowTitle: true, dateRangesHover: true, toDayHighlighted: false, nextDayHighlighted: false, daysOfWeekHighlighted: [0, 6], formatDate: 'yyyy-mm-dd', dateCheckIn: null, dateCheckOut: null, startDate: null, endDate: null, limitPrevMonth: 0, limitNextMonth: 11, limitDateRanges: 100, showFullDateRanges: false, fnDataEvent: null };
    var update_options;
