...
/////////// add room
$('.room-box-parent:first-child').attr('id', 1);
$('.room-plus').click(function() {
    var html = "";
    var roomCount = $('.room-box-parent').length + 1;

    html += '<div class="room-box-parent" id="' + roomCount + '">';
    ...
    html += '<div class="text-muted age-notify">under 17 years old</div>';
    html += '</li>';
    html += '<li class="list-inline-item mt-2 text-right">';
    html += '<div class="count-item count-minus"><i class="fa fa-minus fa-fw"></i></div>';
...
var html = '';
$('.adult-guests .guest-number').val(1); // set default value
$('.children-guests .guest-number').val(0); // set default value
$('.room-box-wrapper').on('click', '.children-guests .count-plus', function() {
    ...
    var roomid = $(this).parents('.room-box-parent').attr('id');
    html += '<ul class="list-unstyled">';
    html += '<li class="list-inline-item">';
    html += '<div class="font-weight-bold">Childrens age</div>';
    html += '</li>';
    html += '<li class="list-inline-item childrens-age-select">';
    html += '<select name="rooms[' + roomid + '][children_ages][' + child_count + ']" class="form-control custom-select">';
...
$('.room-box-wrapper').on('click', '.children-guests .count-minus', function() {
    ...
    if (count > 0) {
        ...
        if (length > 0) {
            $(this).parents('.room-box-parent').find('.childrens-age-box ul:last-child').remove();
            html = '';
        }
    }
});
